...
pygeonet_grass_py3.addArguments("-e geoflood","python3 pygeonet_grass_py3")
...
dinfdistdown.addArguments("-e taudem","dinfdistdown","-wg",path,"-fel",fel,"-src",slp,"-ang",ang,"-dd",hand)
...
streamline_segmentation.addArguments("-e geoflood","python3 Streamline_Segmentation.py")
...
grass_delineation_py3.addArguments("-e geoflood","python3 Grass_Delineation_py3.py")
...
forecast_table.addArguments("-e geoflood","python3 Forecast_Table.py")

...
e_preprocess = Executable(namespace="diamond", name="preprocess", version="4.0", installed=False)
e_preprocess.addPFN(PFN("file://" + sys.argv[1] + "/bin/pegasus-keg", "local"))
diamond.addExecutable(e_preprocess)

e_findrange = Executable(namespace="diamond", name="findrange", version="4.0", installed=False)
e_findrange.addPFN(PFN("file://" + sys.argv[1] + "/bin/pegasus-keg", "local"))
diamond.addExecutable(e_findrange)

e_analyze = Executable(namespace="diamond", name="analyze", version="4.0", installed=False)
...
preprocess.addProfile(Profile(Namespace.PEGASUS, key="nodes", value="1"))
preprocess.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))
...
# required resources for the job
frl.addProfile(Profile(Namespace.PEGASUS, key="nodes", value="1"))
frl.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))
diamond.addJob(frl)
...
# required resources for the job
frr.addProfile(Profile(Namespace.PEGASUS, key="nodes", value="1"))
frr.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))
diamond.addJob(frr)
...
# required resources for the job
analyze.addProfile(Profile(Namespace.PEGASUS, key="nodes", value="1"))
analyze.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))

...
pitremove.addArguments("-e taudem","-m",os.getenv('num_tasks'),"'pitremove -z",sablake,"-fel",fel+"'")
...
dinfflowdir.addArguments("-e taudem","-m",os.getenv('num_tasks'),"'dinfflowdir -fel",fel,"-slp",slp,"-ang",ang+"'")
...
dinfdistdown.addArguments("-e taudem","-m",os.getenv('num_tasks'),"'dinfdistdown -src",nhdflowline,"-fel",fel,"-slp",slp,"-ang",ang,"-dd",hand,"-m ave v'")
...
catchhydrogeo.addArguments("-e taudem","-m",os.getenv('num_tasks'),"'catchhydrogeo -catchlist",river_attribute,"-h",stage,"-slp",slp,"-catch",segmentcatchmenttif,"-hand",hand,"-table",hydroprop_basetable+"'")
...
inunmap.addArguments("-e taudem","-m",os.getenv('num_tasks'),"'inunmap -forecast",nwm_conusnc,"-catch",segmentcatchmenttif,"-hand",hand,"-mapfile",nwm_inunmap+"'")
